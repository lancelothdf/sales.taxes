...
#' In this file we only use state tax variation to reduce measurement error
...
# Collapse rates to the quarter as the mean: use state tax rates as sales tax rate
all_pi[, quarter := ceiling(month / 3)]
all_pi <- all_pi[, list(sales_tax = mean(state_tax)) , 
...
fwrite(purchases.full, "cleaning/consumer_panel_q_hh_group_2006-2016_statetax.csv")