...
et.all <- fread("pi_data/removing_2013Q1/pi_allgoods_es_no2013Q1_productFE.csv")
...
ggsave("pi_figs/pretty/removing_2013Q1/pi_all_event_no2013Q1_productFE.png",
       height = 120 * 1.2, width = 180 * 1.2, units = "mm")


## taxable goods, event time ---------------------------------------------------
et.taxable <- fread("pi_data/removing_2013Q1/pi_taxable_es_no2013Q1_productFE.csv")
...
ggsave("pi_figs/pretty/removing_2013Q1/pi_taxable_event_no2013Q1_productFE.png",
       height = 120 * 1.2, width = 180 * 1.2, units = "mm")

## tax exempt goods, event time ------------------------------------------------
et.taxexempt <- fread("pi_data/removing_2013Q1/pi_taxexempt_es_no2013Q1_productFE.csv")
...
ggsave("pi_figs/pretty/removing_2013Q1/pi_taxexempt_event_no2013Q1_productFE.png",
       height = 120 * 1.2, width = 180 * 1.2, units = "mm")
...
ggsave("pi_figs/pretty/removing_2013Q1/pi_everdecrease_event_no2013Q1_productFE.png",
       height = 120 * 1.2, width = 180 * 1.2, units = "mm")
...
ggsave("pi_figs/pretty/removing_2013Q1/pi_everincrease_event_no2013Q1_productFE.png",
       height = 120 * 1.2, width = 180 * 1.2, units = "mm")
...
ggsave("pi_figs/pretty/removing_2013Q1/pi_increaseonly_event_no2013Q1_productFE.png",
       height = 120 * 1.2, width = 180 * 1.2, units = "mm")
