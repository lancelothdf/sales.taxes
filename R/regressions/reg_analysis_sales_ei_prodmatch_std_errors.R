...
output.residuals.sales.filepath <- "Data/pi_ei_regression_prodmatch_residuals_sales_combined.csv"
...
###OUTPUT
output.cov.sales <- "Data/pi_ei_regression_prodmatch_sales_varcov_matrix_combined.csv"
...
write.table(residual.mat, "Data/large_vcov_matrices/Mat_residuals_prodmatch_ei_sales_combined.csv")
...
output.estimates.stderr.filepath <- "Data/Sales_estimates_stderr_ei_combined.csv"
