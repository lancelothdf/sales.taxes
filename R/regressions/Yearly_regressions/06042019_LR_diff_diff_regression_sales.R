...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg0.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm], ylim = c(-0.05, 0.04), xlab = "Time to event", ylab = "log consumer price index (1)", lty = 3, col = "green", type = "b")
title(main = "Average log consumer price index", sub = "Raw means")
...
#setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg4.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm3], ylim = c(-.008, 0.006), xlab = "Time to event", ylab = "log consumer price index (1)", lty = 3, col = "green", type = "b")
title(main = "Average log consumer price index", sub = "After store by year + module by year FE")
