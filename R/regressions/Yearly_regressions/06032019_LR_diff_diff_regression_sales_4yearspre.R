...
for(j in 1:length(list.outcomes)) {
  ...
  for (k in 2009:2014) {
    ...
    setkey(decrease_store_modules, store_code_uc, product_module_code)
        ...
        data.year.j <- diff_data[year >= k-4 & year <= min(k+3, 2014), ]
...
#pre.trend.data <- pre.trend.data[cohort <= 2013]
...
avg.pre.trend <- avg.pre.trend[tt_event <= 1] ## We keep only two post period data points
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg0.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm], ylim = c(-0.07, 0.04), xlab = "Time to event", ylab = "log consumer price index (1)", lty = 3, col = "green", type = "b")
title(main = "Average log consumer price index", sub = "Raw means")
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg1.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm0], ylim = c(-.018, 0.015), xlab = "Time to event", ylab = "log consumer price index (1)", lty = 3, col = "green", type = "b")
title(main = "Average log consumer price index", sub = "After year FE")
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg3.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm2], ylim = c(-.012, 0.007), xlab = "Time to event", ylab = "log consumer price index (1)", lty = 3, col = "green", type = "b")
title(main = "Average log consumer price index", sub = "After store by year FE")
...
points(pre.trend.nochange[tt_event >= 0, tt_event], pre.trend.nochange[tt_event >= 0, full_pass_inc], lty = 2, col = "grey", type = "b")
points(pre.trend.nochange[tt_event >= 0, tt_event], pre.trend.nochange[tt_event >= 0, full_pass_dec], lty = 2, col = "grey", type = "b")
legend(x = -4, y = -0.003, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0", "Full Passthrough"), lty = c(3,1,3, 2), col = c("green", "black", "red", "grey"))
abline(v=0, lty = 2, col = "grey")
dev.off()
...
#setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg4.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm3], ylim = c(-.008, 0.005), xlab = "Time to event", ylab = "log consumer price index (1)", lty = 3, col = "green", type = "b")
title(main = "Average log consumer price index", sub = "After store by year + module by year FE")
...
points(pre.trend.nochange[tt_event >= 0, tt_event], pre.trend.nochange[tt_event >= 0, full_pass_inc], lty = 2, col = "grey", type = "b")
points(pre.trend.nochange[tt_event >= 0, tt_event], pre.trend.nochange[tt_event >= 0, full_pass_dec], lty = 2, col = "grey", type = "b")
legend(x = -4, y = -0.0025, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0", "Full Passthrough"), lty = c(3,1,3, 2), col = c("green", "black", "red", "grey"))
abline(v=0, lty = 2, col = "grey")
dev.off()
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei2_yearly_reg1.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm0], ylim = c(-.014, 0.011), xlab = "Time to event", ylab = "log consumer price index (2)", lty = 3, col = "green", type = "b")
title(main = "Average log consumer price index", sub = "After year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm0], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm0], lty = 3, col = "red", type = "b")
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei2_yearly_reg2.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm1], ylim = c(-.008, 0.006), xlab = "Time to event", ylab = "log consumer price index (2)", lty = 3, col = "green", type = "b")
title(main = "Average log consumer price index", sub = "After module by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm1], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm1], lty = 3, col = "red", type = "b")
points(pre.trend.nochange[tt_event >= 0, tt_event], pre.trend.nochange[tt_event >= 0, full_pass_inc], lty = 2, col = "grey", type = "b")
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei2_yearly_reg3.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm2], ylim = c(-.009, 0.008), xlab = "Time to event", ylab = "log consumer price index (2)", lty = 3, col = "green", type = "b")
title(main = "Average log consumer price index", sub = "After store by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm2], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm2], lty = 3, col = "red", type = "b")
points(pre.trend.nochange[tt_event >= 0, tt_event], pre.trend.nochange[tt_event >= 0, full_pass_inc], lty = 2, col = "grey", type = "b")
...
setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg0.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm], ylim = c(-0.06, 0.06), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "Raw means")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm], lty = 3, col = "red", type = "b")
...
setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg1.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm0], ylim = c(-.02, 0.01), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm0], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm0], lty = 3, col = "red", type = "b")
...
setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg2.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm1], ylim = c(-.005, 0.012), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After module by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm1], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm1], lty = 3, col = "red", type = "b")
...
setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg3.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm2], ylim = c(-.021, 0.013), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After store by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm2], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm2], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.01, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
#setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg4.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm3], ylim = c(-.003, 0.006), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After store by year + module by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm3], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm3], lty = 3, col = "red", type = "b")
...
setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg0.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm], ylim = c(-0.045, 0.022), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "Raw means")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.01, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg1.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm0], ylim = c(-.025, 0.015), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm0], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm0], lty = 3, col = "red", type = "b")
legend(x = -2.5, y = -0.01, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg2.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm1], ylim = c(-.004, 0.01), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After module by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm1], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm1], lty = 3, col = "red", type = "b")
...
setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg3.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm2], ylim = c(-.02, 0.014), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After store by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm2], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm2], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.01, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
#setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg4.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm3], ylim = c(-.003, 0.005), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After store by year + module by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm3], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm3], lty = 3, col = "red", type = "b")
