...
########################################################
#######################################################
## Also try a different way: store_code_uc FE + pair_by_module_by_time
## Where to save results
output.results.file <- "Data/LRdiff_results_LRspec_bordercounties_wstoreFE.csv"



### Price
formula0 <- as.formula(paste0(
  "ln_cpricei2 ~ ln_sales_tax:year | pair_by_module_by_time + store_by_time | 0 | state_by_module "
))
...
### Quantity
formula1 <- as.formula(paste0(
  "ln_quantity2 ~ ln_sales_tax:year | pair_by_module_by_time + store_by_time | 0 | state_by_module "
))
