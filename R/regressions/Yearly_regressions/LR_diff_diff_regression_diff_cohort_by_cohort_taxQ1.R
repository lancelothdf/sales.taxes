...
yearly_data[, d_lcpricei_Q1 := -diff(ln_cpricei_Q1)] ## Difference of log consumer price index (1)
yearly_data$d_lcpricei_Q1[yearly_data$year <= 2006] <- NA

yearly_data[, d_lcpricei2_Q1 := -diff(yearly_data$ln_cpricei2_Q1)] ## Difference of log consumer price index (2)
yearly_data$d_lcpricei2_Q1[yearly_data$year <= 2006] <- NA
...
yearly_data[, d_lquantity_Q1 := -diff(yearly_data$ln_quantity_Q1)] ## Difference of log quantity (1)
yearly_data$d_lquantity[yearly_data$year <= 2006] <- NA

yearly_data[, d_lquantity2_Q1 := -diff(yearly_data$ln_quantity2_Q1)] ## Difference of log quantity (2)
yearly_data$d_lquantity2_Q1[yearly_data$year <= 2006] <- NA
...
list.outcomes <- c("d_lcpricei", "d_lcpricei2", "d_lcpricei_Q1", "d_lcpricei2_Q1", "d_lquantity", "d_lquantity2", "d_lquantity_Q1", "d_lquantity2_Q1")
...
fwrite(LRdiff_res, "Data/LRdiff_results_diff_cohortbycohort_taxQ1.csv")
