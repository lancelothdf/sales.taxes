...
## output filepaths ----------------------------------------------
output.results.file <- "Data/allpol_yearly_difftolev.csv"
...
#       out.pred.file <- paste0(output.path,"/D standard tolev/predict", Y, "_", n,"_", FE,".csv")
#       fwrite(coef.dt, out.pred.file)
#       
#       # Output file
#       graphout <- paste0(output.path,"/D standard tolev/", Y, "_", n,"_", FE, ".png")
#       # Plot
...
#       out.pred.file <- paste0(output.path,"/D standard tolev full/predict", Y, "_", n,"_", FE,".csv")
#       fwrite(coef.dt, out.pred.file)
#       
#       # Output file
#       graphout <- paste0(output.path,"/D standard tolev full/", Y, "_", n,"_", FE, ".png")
#       # Plot
...
for (n in 2:4) {
  # First create power
  all_pi[, paste0("w.ln_sales_tax_init_",n) := w.ln_sales_tax*(hermite(L.ln_sales_tax, n))]
  # Add to formula
  RHS <- paste(RHS, paste0("w.ln_sales_tax_init_",n), sep = " + ")
