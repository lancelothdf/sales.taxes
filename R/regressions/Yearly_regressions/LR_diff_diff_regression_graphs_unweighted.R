...
pre_trend_data_path <- "Data/Nielsen/pre_trend_data_yearly_unweighted.csv"
...
list.outcomes <- c("ln_cpricei", "ln_cpricei2", "ln_quantity", "ln_quantity2", "ln_sales_tax")
for(j in 1:length(list.outcomes)) {
  ...
  for (k in 2009:2014) {
    ...
    setkey(decrease_store_modules, store_code_uc, product_module_code)
        ...
        increase.data.j <- increase.data.j[, list(dltax = mean(dltax), outcome = mean(outcome), outcome_res0 = mean(outcome_res0), outcome_res1 = mean(outcome_res1), outcome_res2 = mean(outcome_res2), outcome_res3 = mean(outcome_res3), outcome_res4 = mean(outcome_res4), outcome_res5 = mean(outcome_res5), outcome_res6 = mean(outcome_res6), outcome_res7 = mean(outcome_res7), totsales = sum(base.sales), n = .N), by = .(year)]
...
setEPS()
postscript('Graphs/pretrends/ln_sales_tax_yearly_reg0_unweighted.eps')
...
### No FE - Not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_cpricei_yearly_reg0_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg0_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm], ylim = c(-0.06, 0.06), xlab = "Time to event", ylab = "log consumer price index (1)", lty = 3, col = "green", type = "b")
title(main = "Average log consumer price index", sub = "Raw means")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm], lty = 3, col = "red", type = "b")
legend(x = -3, y = 0.05, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
abline(v=0, lty = 2, col = "grey")
dev.off()
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg1_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg2_unweighted.eps')
...
#setEPS()
#postscript('Graphs/pretrends/ln_cpricei_yearly_reg3_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg3_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm2], ylim = c(-.008, 0.008), xlab = "Time to event", ylab = "log consumer price index (1)", lty = 3, col = "green", type = "b")
title(main = "Average log consumer price index", sub = "After store by year FE")
...
#setEPS()
#postscript('Graphs/pretrends/ln_cpricei_yearly_reg4_unweighted.eps')
...
### Module by Year + Store by Year FE - normalized at -2
### Create counter-factual under full-passthrough
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg5_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg6_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg7_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_yearly_reg8_unweighted.eps')
...
### No FE - Not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_cpricei2_yearly_reg0_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei2_yearly_reg0_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm], ylim = c(-0.05, 0.05), xlab = "Time to event", ylab = "log consumer price index (2)", lty = 3, col = "green", type = "b")
title(main = "Average log consumer price index", sub = "Raw means")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm], lty = 3, col = "red", type = "b")
...
### Year FE - not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_cpricei2_yearly_reg1_unweighted.eps')
...
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm0], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm0], lty = 3, col = "red", type = "b")
legend(x = -2.5, y = -0.005, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
abline(v=0, lty = 2, col = "grey")
dev.off()
...
### Module by Year FE - not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_cpricei2_yearly_reg2_unweighted.eps')
...
### Store by Year FE - not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_cpricei2_yearly_reg3_unweighted.eps')
...
### Store by Year + Module by Year FE - not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_cpricei2_yearly_reg4_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei2_yearly_reg5_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei2_yearly_reg6_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei2_yearly_reg7_unweighted.eps')
...
### No FE - Not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_quantity_yearly_reg0_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg0_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm], ylim = c(-0.08, 0.05), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "Raw means")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.04, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
### Year FE - not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_quantity_yearly_reg1_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg1_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm0], ylim = c(-.05, 0.025), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm0], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm0], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.02, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
### Module by Year FE - not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_quantity_yearly_reg2_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg2_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm1], ylim = c(-.02, 0.01), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After module by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm1], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm1], lty = 3, col = "red", type = "b")
...
### Store by Year FE - not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_quantity_yearly_reg3_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg3_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm2], ylim = c(-.025, 0.025), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After store by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm2], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm2], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.01, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
### Store by Year + Module by Year FE - not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_quantity_yearly_reg4_unweighted.eps')
...
### Module by Year + Region by Year FE - normalized at -1
setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg5_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm4], ylim = c(-.012, 0.005), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
...
### Module by Year + Division by Year FE - normalized at -1
setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg6_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm5], ylim = c(-.01, 0.005), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After module by year + Division by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm5], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm5], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.0045, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
abline(v=0, lty = 2, col = "grey")
dev.off()
...
### Module by Region by Year FE - normalized at -1
setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg7_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm6], ylim = c(-.012, 0.005), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After module by region by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm6], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm6], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.006, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
abline(v=0, lty = 2, col = "grey")
dev.off()
...
### Module by Division by Year FE - normalized at -1
setEPS()
postscript('Graphs/pretrends/ln_quantity_yearly_reg8_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm7], ylim = c(-.011, 0.004), xlab = "Time to event", ylab = "log quantity (1)", lty = 3, col = "green", type = "b")
...
### No FE - Not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_quantity2_yearly_reg0_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg0_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm], ylim = c(-0.07, 0.05), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "Raw means")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.01, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
### Year FE - not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_quantity2_yearly_reg1_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg1_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm0], ylim = c(-.06, 0.04), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm0], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm0], lty = 3, col = "red", type = "b")
...
### Module by Year FE - not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_quantity2_yearly_reg2_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg2_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm1], ylim = c(-.014, 0.01), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After module by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm1], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm1], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.006, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
### Store by Year FE - not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_quantity2_yearly_reg3_unweighted.eps')
...
setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg3_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm2], ylim = c(-.03, 0.03), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After store by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm2], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm2], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.01, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
### Store by Year + Module by Year FE - not normalized
#setEPS()
#postscript('Graphs/pretrends/ln_quantity2_yearly_reg4_unweighted.eps')
...
### Module by Year + Region by Year FE - normalized at -1
setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg5_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm4], ylim = c(-.012, 0.005), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After module by year + region by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm4], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm4], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.005, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
### Module by Year + Division by Year FE - normalized at -1
setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg6_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm5], ylim = c(-.01, 0.006), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After module by year + division by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm5], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm5], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.006, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
### Module by Region by Year FE - normalized at -1
setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg7_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm6], ylim = c(-.012, 0.005), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After module by region by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm6], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm6], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.006, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
### Module by Division by Year FE - normalized at -1
setEPS()
postscript('Graphs/pretrends/ln_quantity2_yearly_reg8_unweighted.eps')
plot(pre.trend.increase[, tt_event], pre.trend.increase[, outcome_norm7], ylim = c(-.011, 0.005), xlab = "Time to event", ylab = "log quantity (2)", lty = 3, col = "green", type = "b")
title(main = "Average log quantity", sub = "After module by division by year FE")
points(pre.trend.nochange[, tt_event], pre.trend.nochange[, outcome_norm7], lty = 1, col = "black", type = "b")
points(pre.trend.decrease[, tt_event], pre.trend.decrease[, outcome_norm7], lty = 3, col = "red", type = "b")
legend(x = -3, y = -0.006, legend = c("Tax increase at t=0", "No tax change at t=0", "Tax decrease at t=0"), lty = c(3,1,3), col = c("green", "black", "red"))
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei_quantity_yearly_unweighted.eps')
plot(pre.trend.price.increase[, tt_event], pre.trend.price.increase[, outcome_norm6], ylim = c(-.005, 0.012), xlab = "Time to event", ylab = "log price & log quantity (1)", lty = 1, col = "green", type = "b")
...
legend(x = -3, y = 0.011, legend = c("Price (increase)", "Price (no change)", "Price (decrease)", "-Quantity (increase)", "-Quantity (no change)", "-Quantity (decrease)"), lty = c(1,1,1,3,3,3), col = c("green", "black", "red", "green", "black", "red"))
abline(v=0, lty = 2, col = "grey")
dev.off()
...
setEPS()
postscript('Graphs/pretrends/ln_cpricei2_quantity2_yearly_unweighted.eps')
plot(pre.trend.price.increase[, tt_event], pre.trend.price.increase[, outcome_norm6], ylim = c(-.005, 0.012), xlab = "Time to event", ylab = "log price & log quantity (2)", lty = 1, col = "green", type = "b")
