...
## output filepaths ----------------------------------------------
iv.output.results.file <- "Data/Demand_iv_sat_initial_price_semester_boot_r_county.csv"
theta.output.results.file <- "Data/Demand_theta_sat_initial_price_semester_boot_r_county.csv"
