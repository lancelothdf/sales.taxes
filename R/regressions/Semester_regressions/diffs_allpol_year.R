...
## This is a Robustness (3) to main specification: 10/17/19. The Short run version
...
## output filepaths ----------------------------------------------
output.results.file <- "Data/allpol_yearly_diff.csv"
...
########## Code Ends HERE. No need to run the hermite polynomials ---------------------
