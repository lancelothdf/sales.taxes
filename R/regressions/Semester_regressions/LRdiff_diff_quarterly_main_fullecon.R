...
## output filepaths ----------------------------------------------
reg.outfile <- "Data/LRdiff_quarterly_results_main_fullecon.csv"
...
form_homeprice_lags <- paste0("L", 1:6, ".D.ln_home_price", collapse = "+")
form_homeprice_leads <- paste0("F", 1:6, ".D.ln_home_price", collapse = "+")
