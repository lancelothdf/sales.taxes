...
## output filepaths ----------------------------------------------
output.results.file <- "Data/LRdiff_semesterly_results_preferred_cumulative_part1_borderstates.csv"
...
all_pi <- all_pi[, c("fips_state", "fips_county", "year", "semester", "store_code_uc", "product_module_code", "ln_cpricei", "ln_sales_tax", "ln_quantity", "base.sales", "cal_time", "module_by_time", "module_by_state", "ln_home_price", "ln_unemp")]
