...
pre_trend_data_path <- "Data/Nielsen/pre_trend_data_semester_taxQ2.csv"
...
##!!! HEre we use ln_sales_tax_Q2 not ln_sales_tax
yearly_data$dltax <- -diff(yearly_data$ln_sales_tax_Q2) ## Difference log of tax rate
yearly_data$dltax[yearly_data$year <= 2008] <- NA



### First produce graphs to explore pre-trends
list.outcomes <- c("ln_cpricei", "ln_quantity", "ln_sales_tax", "ln_sales_tax_Q2")
