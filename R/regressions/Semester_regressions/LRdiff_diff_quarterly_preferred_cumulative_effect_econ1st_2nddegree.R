...
## output filepaths ----------------------------------------------
output.results.file <- "Data/LRdiff_quarterly_results_preferred_cumulative_econ1st_2nddegree.csv"
...
formula_RHS <- paste0(formula_RHS, " + lag.unemp0 + lag.unemp1 + lag.home_price0 + lag.home_price1")
