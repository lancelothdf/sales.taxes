#' Author: John Bonney
#'
#' Address to-do items sent to me from Lance on June 26, 2019.
...
## output filepaths ----------------------------------------------
reg.outfile <- "Data/quarterly_pi_output_8Lag7Lead.csv"
...
lag.vars <- paste(paste0("L", 7:1, ".D.ln_sales_tax"), collapse = " + ")
...
paired.leads.lags <- c("F8.D.ln_sales_tax + F7.D.ln_sales_tax",
                       "F6.D.ln_sales_tax + F5.D.ln_sales_tax",
                       "F4.D.ln_sales_tax + F3.D.ln_sales_tax",
                       "F2.D.ln_sales_tax + F1.D.ln_sales_tax",
                          "D.ln_sales_tax + L1.D.ln_sales_tax",
                       "L2.D.ln_sales_tax + L3.D.ln_sales_tax",
                       "L4.D.ln_sales_tax + L5.D.ln_sales_tax",
                       "L6.D.ln_sales_tax + L7.D.ln_sales_tax")
