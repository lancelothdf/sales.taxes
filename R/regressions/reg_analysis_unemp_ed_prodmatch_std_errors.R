...
output.results.filepath <- "Data/unemp_ed_monthly_regression_res_prodmatch_combined.csv"
output.residuals.cpricei.filepath <- "Data/unemp_ed_monthly_regression_prodmatch_residuals_cpricei_combined.csv"
output.residuals.tax.filepath <-"Data/unemp_ed_monthly_regression_prodmatch_residuals_tax_combined.csv"
output.xx.filepath <- "Data/unemp_ed_monthly_regression_prodmatch_xx_combined.csv"
...
###OUTPUT
output.cov.cpricei <- "Data/unemp_ed_monthly_regression_prodmatch_cpricei_varcov_matrix_combined.csv"
output.skeleton <- "Data/unemp_ed_monthly_regression_prodmatch_varcov_matrix_skeleton_combined.csv"

### INPUTS
output.results.filepath <- "Data/unemp_ed_monthly_regression_res_prodmatch_combined.csv"
output.residuals.cpricei.filepath <- "Data/unemp_ed_monthly_regression_prodmatch_residuals_cpricei_combined.csv"
#output.residuals.tax.filepath <-"Data/unemp_ed_monthly_regression_prodmatch_residuals_tax_combined.csv" ##We do not need this one here because we are interested in unemployment
output.xx.filepath <- "Data/unemp_ed_monthly_regression_prodmatch_xx_combined.csv"
...
output.estimates.stderr.filepath <- "Data/Unemp_estimates_stderr_ed_monthly_combined.csv"
