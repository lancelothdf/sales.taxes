...
# Running Basic Estimations on the new panel (household aggregate x semester)
...
purchases.sample[, time := .GRP, by = .(year, semester)]


## Estimations: Expenditure on type of module --------

output.results.file <- "../../../../../home/slacouture/HMS/HH_semester_basic.csv"
