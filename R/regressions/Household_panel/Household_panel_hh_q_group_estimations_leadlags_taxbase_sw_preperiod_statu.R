...
# In this version we only use the "statutory rate" regression
...
output.results.file <- "../../../../../home/slacouture/HMS/HH_group_quarter_distributed_lags_statutoryfull_taxbase.csv"
...
## Estimation Set up on statutory --------
output.results.file <- "../../../../../home/slacouture/HMS/HH_group_quarter_distributed_lags_statutoryfull_taxableconsumer.csv"
