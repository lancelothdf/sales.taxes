...
##################### Run only 4 leads and lags -----------------------------------

## Estimation Set up --------
output.results.file <- "../../../../../home/slacouture/HMS/HH_quarter_distributed_lags_4ll.csv"
...
### Keep households that stay at least 4 years in the panel ------------
output.results.file <- "../../../../../home/slacouture/HMS/HH_quarter_distributed_lags_4ll_4years.csv"
