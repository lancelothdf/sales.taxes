...
# Divide the states in two groups - those for which the tax base is large versus tax base is low. 
...
## Estimation dividing state type (large tax base) ----------

output.decriptives.file <- "../../../../../home/slacouture/HMS/HH_quarter_leadslags_describe_taxbase.csv"
output.results.file <- "../../../../../home/slacouture/HMS/HH_quarter_leadslags_cumulative_taxbase.csv"
