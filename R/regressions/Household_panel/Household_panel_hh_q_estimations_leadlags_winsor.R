...
## Winsorize outcomes (1%) -------
purchases.sample <- purchases.sample[ , c(outcomes, outcomes_t) := (lapply(.SD, Winsorize, probs = c(0.01,0.99), na.rm = T)), .SDcols = c(outcomes, outcomes_t)]
