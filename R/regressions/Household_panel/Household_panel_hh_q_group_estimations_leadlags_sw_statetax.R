...
# run against state statutory tax rates
...
rm(all_pi)
purchases.sample <- purchases.sample[, ln_sales_tax := log1p(state_tax)]
...
## Estimation Set up --------
output.decriptives.file <- "../../../../../home/slacouture/HMS/HH_group_quarter_leadslags_describe_state.csv"
output.results.file <- "../../../../../home/slacouture/HMS/HH_group_quarter_distributed_lags_weighted_state.csv"

outcomes <- c("D.ln_expenditures", "D.ln_share", "D.ln_expenditures_taxable", "D.ln_expenditures_non_taxable",
              "D.ln_share_taxable",  "D.ln_share_non_taxable", "D.ln_statutory_sales_tax")
