...
## Open Data
purchases.sample <- fread("cleaning/consumer_panel_q_hh_group_2006-2016_statetax.csv")
...
## Estimation Set up --------
output.decriptives.file <- "../../../../../home/slacouture/HMS/HH_group_quarter_leadslags_describe_statetax.csv"
output.results.file <- "../../../../../home/slacouture/HMS/HH_group_quarter_distributed_lags_statetax.csv"
