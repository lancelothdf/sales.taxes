...
output.results.file <- "../../../../../home/slacouture/HMS/HH_month_leadslags_12span_cumulative.csv"
...
formula_lags <- paste0("L", 1:12, ".D.ln_sales_tax", collapse = "+")
formula_leads <- paste0("F", 1:12, ".D.ln_sales_tax", collapse = "+")
formula_RHS <- paste0("D.ln_sales_tax + ", formula_lags, "+", formula_leads)

## for linear hypothesis tests
lead.vars <- paste(paste0("F", 12:1, ".D.ln_sales_tax"), collapse = " + ")
lag.vars <- paste(paste0("L", 12:1, ".D.ln_sales_tax"), collapse = " + ")
...
for (FE in FE_opts) {
  for (Y in c(outcomes, outcomes_t)) {
    ...
    ## linear hypothesis results
    lp.dt <- data.table(
      rn = c("cumul.lead12.D.ln_sales_tax", "cumul.lead11.D.ln_sales_tax", "cumul.lead10.D.ln_sales_tax", "cumul.lead9.D.ln_sales_tax", 
             ...
             "cumul.lag9.D.ln_sales_tax", "cumul.lag10.D.ln_sales_tax", "cumul.lag11.D.ln_sales_tax", "cumul.lag12.D.ln_sales_tax"),
      Estimate = c(cumul.lead12.est, cumul.lead11.est, cumul.lead10.est, cumul.lead9.est,
                   ...
                   cumul.lag9.est, cumul.lag10.est, cumul.lag11.est, cumul.lag12.est),
      `Cluster s.e.` = c(cumul.lead12.se, cumul.lead11.se, cumul.lead10.se, cumul.lead9.se,
                       ...
                       cumul.lag9.se, cumul.lag10.se, cumul.lag11.se, cumul.lag12.se),
      `Pr(>|t|)` = c(cumul.lead12.pval, cumul.lead11.pval, cumul.lead10.pval, cumul.lead9.pval,
                     ...
                     cumul.lag9.pval, cumul.lag10.pval, cumul.lag11.pval, cumul.lag12.pval),
      outcome = Y,
      spec = FE,
      Rsq = summary(res1)$r.squared,
      adj.Rsq = summary(res1)$adj.r.squared)
...
output.results.file <- "../../../../../home/slacouture/HMS/HH_month_leadslags_cumulative_12span_4years.csv"
...
output.results.file <- "../../../../../home/slacouture/HMS/HH_month_leadslags_cumulative_12span_nonmovers.csv"
