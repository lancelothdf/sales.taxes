#' Author: John Bonney
#'
#' This file creates event-study means plots based on median home prices. The
#' home prices are weighted the same as the price indices are weighted.
...
#'
#' E.g., $ Rscript cohort_specific_all_pooled.R "Ever increase" "Data/homeprice_all_cohorts_ei_pooled.csv"
