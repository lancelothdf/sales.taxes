...
#'
#' A notable change in this version is that we match on propensity scores, which
#' are calculated based on geographic, housing price, and unemployment characteristics.
#'
#' Command line argument one: the change of interest.
#' Command line argument two: the output filepath.
#'
#' E.g., $ Rscript cohort_specific_matched.R "Ever increase" "Data/pi_all_cohorts_ei_pooled_taxable_matched.csv"
