#' Author: John Bonney
#'
#' This file creates event-study means plots based on the unemployment rate. The
#' unemployment rate is weighted the same as the price indices are weighted.
#' This file adapts explore_pi_pre_trends.R to removes reforms in
...
#'
#' E.g., $ Rscript cohort_specific_all_pooled.R "Ever increase" "Data/unemprate_all_cohorts_ei_pooled.csv"
