...
## Outputs ----------------------------------------------
output.table <- "Data/objective_state_bernestein_extrapolate.csv"
...
data.full <- rbind(data.full, data.objective)
fwrite(data.full, output.table)
