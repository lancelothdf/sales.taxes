...
for (resid_type in c("A", "B", "C", "D", "E")){
  ...
  compr_outfile <- paste0("Graphs/log_sales_residualized_compr_qly_taxablegoods_", resid_type, "region.png")
  compr_es_outfile <- paste0("Graphs/log_sales_es_residualized_compr_qly_taxablegoods_", resid_type, "region.png")
  restr_outfile <- paste0("Graphs/log_sales_residualized_restr_qly_taxablegoods_", resid_type, "region.png")
  restr_es_outfile <- paste0("Graphs/log_sales_es_residualized_restr_qly_taxablegoods_", resid_type, "region.png")
