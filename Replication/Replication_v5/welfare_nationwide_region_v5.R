...
# Output
out.welfare.nationwide.av <- "Data/Replication_v5/average_nationwide_extrapolation_region.csv"
sol.welfare.nationwide.av <- "Data/Replication_v5/average_nationwide_temp_progress_region.csv"
