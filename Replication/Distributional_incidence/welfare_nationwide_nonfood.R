##### Santiago Lacouture
#' Sales Taxes
#' Replication File. Updated on 11/14/2022
#' Step 13a: Welfare extrapolation. Nationwide average using distribution of prices (and tax rates) on non-food products only.
...
# inputs
binned.data.tax <- "Data/Replication/extraction_state_binned_tax_distributional.csv"
...
# Output
out.welfare.nationwide.av <- "Data/Replication/average_nationwide_extrapolation_nonfood.csv"
sol.welfare.nationwide.av <- "Data/Replication/average_nationwide_temp_progress_nonfood.csv"
...
data <- data[Food == 0,] ## Keep only NonFood items
data[, p_cml := p_m - tau]
data[, tauno := 0]
