...
# Output
out.welfare.nationwide.av <- "Data/Replication_v4/average_nationwide_extrapolation_region.csv"
sol.welfare.nationwide.av <- "Data/Replication_v4/average_nationwide_temp_progress_region.csv"
...
### Workaround a case that was giving us trouble
  if (sigma == 0.5 & theta >= 0.18 & theta <= 0.19 & K== 8 & L == 1) {
    flog.info("Skip the case with L=1; K=8, theta = 0.18, sigma = 0.5")
  }
  else {
