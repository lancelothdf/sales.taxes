...
# Output
out.welfare.nationwide.av <- "Data/Replication_v4/average_nationwide_extrapolation_division_smallv2.csv"
sol.welfare.nationwide.av <- "Data/Replication_v4/average_nationwide_temp_progress_division_smallv2.csv"
