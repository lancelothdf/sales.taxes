...
all_pi <- all_pi[, -c("L1.D.ln_cpricei", "L2.D.ln_cpricei", "L3.D.ln_cpricei")]
...
## Remove leads and lags
all_pi <- all_pi[, -c("L1.D.ln_quantity", "L2.D.ln_quantity", "L3.D.ln_quantity")]
...
## Remove leads and lags
all_pi <- all_pi[, -c("L1.D.ln_quantity2", "L2.D.ln_quantity2", "L3.D.ln_quantity2")]
...
all_pi[, L.ln_sales_tax := ln_sales_tax - DLL.ln_sales_tax]
...
# Save Datasets
fwrite(all_pi, "/project/igaarder/Data/Replication_v4/all_pi_DLL.csv", showProgress = T)
fwrite(all_pi_spill, "/project/igaarder/Data/Replication_v4/all_pi_spill_DLL.csv", showProgress = T)
fwrite(all_pi_spill_econ, "/project/igaarder/Data/Replication_v4/all_pi_spill_econ_DLL.csv", showProgress = T)
fwrite(all_pi_econ, "/project/igaarder/Data/Replication_v4/all_pi_econ_DLL.csv", showProgress = T)
#fwrite(purchases.sample, "/project/igaarder/Data/Replication_v4/purchases.sample.csv", showProgress = T)
