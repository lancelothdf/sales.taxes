##### Santiago Lacouture
#' Sales Taxes
#' Replication File. Updated on 04/20/2022
...
# inputs
theta.bernestein <- "Data/Replication_v4/Demand_gamma_sat_initial_price_semester_boot_r_K_division"
...
# output
partial.results.file <- "Data/Replication_v4/partial_point_results_division.csv"
partial.results.file.boot <- "Data/Replication_v4/partial_point_results_boot_division.csv"
