...
fwrite(all_pi_spill, "/project/igaarder/Data/Replication_v4/all_pi_spill_DL.csv", showProgress = T)
fwrite(all_pi_spill_econ, "/project/igaarder/Data/Replication_v4/all_pi_spill_econ_DL.csv", showProgress = T)
fwrite(all_pi_econ, "/project/igaarder/Data/Replication_v4/all_pi_econ_DL.csv", showProgress = T)
