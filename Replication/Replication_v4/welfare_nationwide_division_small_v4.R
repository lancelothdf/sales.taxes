...
# Output
out.welfare.nationwide.av <- "Data/Replication_v4/average_nationwide_extrapolation_division_small.csv"
sol.welfare.nationwide.av <- "Data/Replication_v4/average_nationwide_temp_progress_division_small.csv"
