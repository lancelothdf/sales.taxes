...
#' This Code Produces the simulation for point identified cases. Relies on true data moments
...
output.results.file <- "Data/Replication/SimulationIV_150.csv"
output.target.file <- "Data/Replication/SimulationTarget_150.csv"
