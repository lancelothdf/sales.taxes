...
## output filepath ----------------------------------------------
iv.output.results.file <- "Data/Replication_v2/IV_subsamples_initprice_DLL_sample2.csv"
output.emp.price.dist <- "Data/Replication_v2/Emp_price_subsamples_initprice_DLL_sample2.csv"
iv.output.results.file.boot <- "Data/Replication_v2/IV_subsamples_initprice_boot_DLL_sample2.csv"
