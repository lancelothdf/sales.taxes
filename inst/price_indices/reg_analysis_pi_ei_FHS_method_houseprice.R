...
output.results.filepath <- "Data/pi_ei_regression_res_prodmatch_combined_FHS_homeprice.csv"
output.residuals.cpricei.filepath <- "Data/pi_ei_regression_prodmatch_residuals_cpricei_combined_FHS_homeprice.csv"
output.residuals.tax.filepath <-"Data/pi_ei_regression_prodmatch_residuals_tax_combined_FHS_homeprice.csv"
output.xx.filepath <- "Data/pi_ei_regression_prodmatch_xx_combined_FHS_homeprice.csv"
...
###OUTPUT
output.cov.cpricei <- "Data/pi_ei_regression_prodmatch_cpricei_varcov_matrix_combined_FHS_homeprice.csv"
output.skeleton <- "Data/pi_ei_regression_prodmatch_varcov_matrix_skeleton_combined_FHS_homeprice.csv"
...
write.table(residual.mat, "Data/large_vcov_matrices/Mat_residuals_prodmatch_ei_pi_combined_FHS_homeprice.csv")
...
output.estimates.stderr.filepath <- "Data/Passthrough_estimates_stderr_ei_combined_FHS_homeprice.csv"
