...
output.residuals.cpricei.filepath <- "Data/pi_ed_regression_prodmatch_residuals_cpricei_combined.csv"
...
###OUTPUT
output.cov.cpricei <- "Data/pi_ed_regression_prodmatch_cpricei_varcov_matrix_combined.csv"
...
write.table(residual.mat, "Data/large_vcov_matrices/Mat_residuals_prodmatch_ed_pi_combined.csv")
...
estprice.pass <- estimates[outcome == 'cpricei' & rn %in% c("catt-4", "catt-3", "catt-1", "catt0", "catt1", "catt2", "catt3", "catt4"), "estimates"]
