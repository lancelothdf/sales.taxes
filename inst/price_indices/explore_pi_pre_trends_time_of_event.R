...
output.all.event.path <- "Data/pi_allgoods_es_time_of_event.csv"
output.taxable.event.path <-"Data/pi_taxable_es_time_of_event.csv"
output.taxexempt.event.path <-"Data/pi_taxexempt_es_time_of_event.csv"
