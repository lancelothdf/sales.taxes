...
data_path <- "output/server/pi_data/ever_increase/pi_all_cohorts_pooled_extended_taxable.csv"
outfile_figpath <- "reports/figs/pi_all_cohorts_ei_pooled_extended_taxable.png"
