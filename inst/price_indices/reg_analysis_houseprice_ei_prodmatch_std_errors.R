...
output.results.filepath <- "Data/homeprice_ei_monthly_regression_res_prodmatch_combined.csv"
output.residuals.normalized.homeprice.filepath <- "Data/homeprice_ei_monthly_regression_prodmatch_residuals_combined.csv"
output.residuals.tax.filepath <-"Data/homeprice_ei_monthly_regression_prodmatch_residuals_tax_combined.csv"
output.xx.filepath <- "Data/homeprice_ei_monthly_regression_prodmatch_xx_combined.csv"
...
###OUTPUT
output.cov.normalized.homeprice <- "Data/homeprice_ei_monthly_regression_prodmatch_varcov_matrix_combined.csv"
output.skeleton <- "Data/homeprice_ei_monthly_regression_prodmatch_varcov_matrix_skeleton_combined.csv"

### INPUTS
output.results.filepath <- "Data/homeprice_ei_monthly_regression_res_prodmatch_combined.csv"
output.residuals.normalized.homeprice.filepath <- "Data/homeprice_ei_monthly_regression_prodmatch_residuals_combined.csv"
#output.residuals.tax.filepath <-"Data/homeprice_ei_monthly_regression_prodmatch_residuals_tax_combined.csv" ##We do not need this one here because we are interested in unemployment
output.xx.filepath <- "Data/homeprice_ei_monthly_regression_prodmatch_xx_combined.csv"
...
output.estimates.stderr.filepath <- "Data/Homeprice_estimates_stderr_ei_monthly_combined.csv"
