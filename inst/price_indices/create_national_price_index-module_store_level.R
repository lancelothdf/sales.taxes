...
# fwrite(pi_data, "Data/Nielsen/price_quantity_indices_food.csv") -- don't write over the store-level balanced doc
...
print(national_pi[])
fwrite(national_pi, "Data/national_price_index_module_store_balanced.csv")
