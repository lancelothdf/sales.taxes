...
output.all.event.path <- "Data/pi_allgoods_es_time_of_event_unrestricted.csv"
output.taxable.event.path <-"Data/pi_taxable_es_time_of_event_unrestricted.csv"
output.taxexempt.event.path <-"Data/pi_taxexempt_es_time_of_event_unrestricted.csv"
...
## group of counties that will be treated in the future (over 4 quarters)
...
###   separately for the different control groups (ref_year X ref_quarter X tr_group)
...
## merge on to attach based on calendar time
matched_control_data <- merge(taxexempt_pi, control_dt,
                              by = c("quarter", "year", "product_module_code",
                                     "ref_year", "ref_quarter", "tr_group"))
matched_control_data <- matched_control_data[, .(control.cpricei, tt_event, event_ID,
                                                 store_code_uc, product_module_code,
