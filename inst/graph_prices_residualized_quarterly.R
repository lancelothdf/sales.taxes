...
## transform data to quarterly
all_nielsen_data[, quarter := ceiling(month / 3)]
all_nielsen_data <- all_nielsen_data[, list(price_w_tax = mean(price_w_tax),
                                            price = mean(price),
                                            sales = sum(sales)),
                                     by = c("fips_state", "fips_county", "product_group_code",
                                            "store_code_uc", "product_module_code", "quarter", "year")]
all_nielsen_data[, month := quarter] # a bit of a fishy workaround (temporary) for normalizing price on quarterly level
...
# fwrite(product_by_county_prices, "Data/Nielsen/product_by_county_prices_.csv")
#
...
price_application(all_nielsen_data,
                  treatment_data_path = "Data/tr_groups_comprehensive.csv",
                  time = "calendar",
                  weighting_var = "sales.weight",
                  pretax_var = "normalized_price",
                  posttax_var = "normalized_price_w_tax",
                  resid_type = "A",
                  w_tax = T,
                  fig_outfile = "Graphs/log_price_trends_compr_posttax_qly_A.png")
...
price_application(all_nielsen_data,
                  ...
                  weighting_var = "sales.weight",
                  pretax_var = "price",
                  posttax_var = "price_w_tax",
                  resid_type = "B",
                  w_tax = T,
                  fig_outfile = "Graphs/log_price_trends_compr_posttax_qly_B.png")
...
price_application(all_nielsen_data,
                  ...
                  resid_type = "C",
                  w_tax = T,
                  fig_outfile = "Graphs/log_price_trends_compr_posttax_qly_C.png")
...
price_application(all_nielsen_data,
                  ...
                  resid_type = "D",
                  w_tax = T,
                  fig_outfile = "Graphs/log_price_trends_compr_posttax_qly_D.png")
...
price_application(all_nielsen_data,
                  ...
                  resid_type = "E",
                  w_tax = T,
                  fig_outfile = "Graphs/log_price_trends_compr_posttax_qly_E.png")
#
# ### RESTRICTIVE DEFINITION ###
# price_application(product_by_county_prices,
#                   treatment_data_path = "Data/tr_groups_restrictive.csv",
