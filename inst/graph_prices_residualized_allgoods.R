...
fwrite(product_by_county_prices, "Data/Nielsen/product_by_county_prices_allgoods.csv")

# product_by_county_prices <- fread("Data/Nielsen/product_by_county_prices_allgoods.csv")
