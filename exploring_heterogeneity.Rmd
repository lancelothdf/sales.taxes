...
As we can see in Figure \ref{fig:plot_dist}, most of the increases are concentrated in 2010 Q3, and most of the decreases are concentrated in 2011 Q3. What is driving these large spikes?
...
![\label{fig:map}Geographical Distribution of Sales Tax Changes](C:/Users/tax_compr.png)

<!-- C:/Users/John Bonney/Desktop/Magne_projects/sales_taxes/output/figs/maps/tax_compr.png -->

The only state-wide tax change that shows up in this map (Figure \ref{fig:map}) but is not captured in the previous analysis is Arizona's June 2010 tax increase, which increased state sales tax by 1%, from 5.6% to 6.6%.
