...
[^2]: Note that, since sales generally increase over time, using this $y_{psqy} implicitly places more weight on later years in the dataset than earlier years. 
